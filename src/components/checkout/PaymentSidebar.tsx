                    ...
                    if (window.NI) {
                        window.NI.mountCardInput("mount-id", {
                            ...
                            onChangeValidStatus: function (_ref:  {
                                ...
                                setCardValidStatus({ isCVVValid, isExpiryValid, isNameValid, isPanValid });
                            },
                        });
                    }
                }}
                        ...
                        <div className="space-y-2 w-full mt-2">
                            {paymentMethods?.data?.map((item: any) => (
                                <div
                                    ...
                                    onClick={() => setPayMethod(item?.card_type)}
                                >
                                    <div className="flex items-center justify-center gap-8">
                                        {/* <p className="text-sm">{item?.card_type}</p> */}
                                        <Image
                                    ...
                                    <div
                                        className={`rounded-full border  p-[3px] size-4 ${payMethod === item?.card_type ? "border-primary" : "border-[#C7C7C7]"
                                            }`}
                                    >
                                        <div className={cn(
                ...
                <div className="w-full flex flex-col items-center justify-center gap-5">
                    ...
                    <div className="w-full rounded-xl border flex flex-col items-center justify-center divide-y">
                        ...
                        >
                            ...
                            <div
                                className={`rounded-full border p-[3px] size-4 ${payMethod === "Online Payment" ? "border-primary" : "border-[#C7C7C7]"
                                    }`}
                            >
                                <div className={cn(
                                    "rounded-full bg-primary w-full h-full",
                        ...
                        >
                            ...
                            <div
                                className={`rounded-full border  p-[3px] size-4 ${payMethod === "Cash on Delivery" ? "border-primary" : "border-[#C7C7C7]"
                                    }`}
                            >
                                <div className={cn(
                                    "rounded-full bg-primary w-full h-full",
                        ...
                        >
                            ...
                            <div
                                className={cn(`rounded-full border p-[3px] size-4`, payMethod === "Card on Delivery" ? "border-primary" : "border-[#C7C7C7]")}
                            >
                                <div className={cn(
                                    "rounded-full bg-primary w-full h-full",
                    ...
                    <div className="w-full h-full flex flex-col items-start justify-start gap-2.5 text-[#555555] pb-24 sm:pb-0">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                showCard && (cardValidStatus && Object.values(cardValidStatus).some((isValid) => !isValid)) ? 'bg-gray-200 text-gray-400' : 'bg-primary text-white'
                            )}
                        >
