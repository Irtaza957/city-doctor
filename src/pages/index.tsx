    ...
    <div className="w-full flex flex-col mb-10 xl:mb-20 items-center justify-center">
      ...
      <div className="flex flex-col items-center text-center justify-center gap-5 sm:w-[70%] md:w-[45%] my-7">
        ...
        <div className="w-full">
          ...
          <div className="w-full text-left text-sm font-medium text-[#535763] space-y-3 !my-3 ml-6">
          ...
          <div className="space-y-3 mt-6 border-t pt-5">
            ...
            <div className="flex flex-col justify-start items-start">
              ...
              <p className="text-xs sm:text-sm text-left mt-3 ml-5">At City Doctor, we provide expert home healthcare services across Dubai, ensuring you receive professional medical care without leaving your home. Whether you need a doctor on call, IV therapy, lab tests, or physiotherapy, our dedicated team is available 24/7, delivering medical services at home in Dubai with convenience, care, and efficiency.</p>
            </div>
            <div className="flex flex-col justify-start items-start">
              <p className="font-semibold">2. &nbsp;IV Drip Therapy at Home – Instant Hydration & Recovery</p>
              <p className="text-xs sm:text-sm text-left mt-3 ml-5">Our IV therapy services at home provide essential hydration, vitamins, and nutrients to boost immunity, energy, and overall well-being. Whether for fatigue, dehydration, hangover recovery, or wellness enhancement, our IV drips are administered by professional nurses.</p>
            </div>
            <div className="flex flex-col justify-start items-start">
              <p className="font-semibold">3. &nbsp;Lab Tests at Home – Fast & Accurate Results</p>
              <p className="text-xs sm:text-sm text-left mt-3 ml-5">Skip the clinic queues! We offer lab tests at home for routine checkups, disease screenings, and diagnostic tests. Our certified team ensures safe sample collection, with fast and accurate results delivered securely.</p>
            </div>
            <div className="flex flex-col justify-start items-start">
              <p className="font-semibold">4. &nbsp;Physiotherapy and Body Adjustment at Home</p>
              <p className="text-xs sm:text-sm text-left mt-3 ml-5">Recover faster and improve mobility with physiotherapy and body adjustment at home. Our expert physiotherapists help with pain management, muscle recovery, posture correction, and joint flexibility. </p>
            </div>
            <p className="text-xs sm:text-sm text-left mt-3 ml-5">Whether you need rehabilitation after an injury, relief from chronic pain, or a personalized body adjustment session, we bring professional care to your doorstep.</p>
          </div>
          <div className=" w-full !my-1 flex flex-col items-start justify-center space-y-3 border-t pt-5 !mt-5">
            ...
            <p className="text-xs sm:text-sm text-center">City Doctor is committed to making healthcare accessible, efficient, and stress-free. Whether you need a doctor on call, an IV drip, or a lab test at home, we are just a call away.</p>
            <p className="text-xs sm:text-sm text-center w-full">Call us now at <span className="font-bold">8005060</span> to book your home medical service in Dubai!</p>
          </div>
        </div>}
