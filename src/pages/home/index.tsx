...
const Home = () => {
  ...
  return (
    <div className="w-full flex flex-col mb-10 xl:mb-20 items-center justify-center">
      ...
      <div className="w-full flex flex-col items-center text-left md:text-center justify-center gap-5 px-4 md:px-2 sm:w-[70%] md:w-[45%] my-7 md:pb-5">
        <div className="w-full">
          <p className="text-xl sm:text-3xl font-bold text-left sm:text-center w-full md:whitespace-nowrap text-[#333333]">About <br />City Doctor</p>
